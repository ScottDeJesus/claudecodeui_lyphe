...
export type DispatcherLanePicture = { plans: DispatcherPlan[]; arcs: DispatcherArc[]; route: DispatcherRoute; daemon: DispatcherDaemon; offpeak_at: string };
