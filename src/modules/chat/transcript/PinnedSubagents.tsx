...
function PinnedSubagents({ messages }: PinnedSubagentsProps) {
  ...
  return (
    ...
    <div className="sticky top-0 z-20 mx-auto mb-2 w-full max-w-[54.25rem] px-4 pr-14">
      <div className="flex flex-col gap-1 rounded-xl border border-purple-500/25 bg-popover/95 p-1.5 shadow-sm backdrop-blur-sm dark:border-purple-400/25">
