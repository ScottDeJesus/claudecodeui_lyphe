...
import MarkdownCodeBlock from '@/modules/markdown-preview/MarkdownCodeBlock';
...
/** Used by the prd-editor module to render markdown source as formatted preview output. */
