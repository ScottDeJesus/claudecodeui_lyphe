...
import MermaidDiagram from '@/modules/markdown-preview/MermaidDiagram';
...
/** Used by MarkdownPreview inside this module to render fenced code blocks with syntax highlighting, copy support and mermaid diagrams. */
    ...
    <div className="group relative my-2">
      ...
      <SyntaxHighlighter
        ...
        customStyle={{
          ...
          ...(isDarkMode ? {} : { background: 'var(--surface2)' }),
        }}
