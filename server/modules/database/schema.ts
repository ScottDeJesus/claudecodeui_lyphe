...
export const CRON_JOBS_TABLE_SCHEMA_SQL = `
CREATE TABLE IF NOT EXISTS cron_jobs (
  id TEXT PRIMARY KEY, kind TEXT NOT NULL, name TEXT NOT NULL, purpose TEXT,
  owner TEXT NOT NULL, origin TEXT NOT NULL, expression TEXT NOT NULL,
  schedule_text TEXT NOT NULL, command TEXT NOT NULL, log_path TEXT,
  state TEXT NOT NULL DEFAULT 'unknown', drift TEXT NOT NULL DEFAULT 'none',
  drift_detail TEXT, last_run_at TEXT, last_result TEXT, next_run_at TEXT, note TEXT,
...
export const CRON_SYNC_RUNS_TABLE_SCHEMA_SQL = `
CREATE TABLE IF NOT EXISTS cron_sync_runs (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  ran_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, ok INTEGER NOT NULL, error TEXT,
  seen INTEGER NOT NULL DEFAULT 0, adopted INTEGER NOT NULL DEFAULT 0,
  missing INTEGER NOT NULL DEFAULT 0, changed INTEGER NOT NULL DEFAULT 0,
