 ...
 * `cost_usd` is PAID dollars — a soul on the operator's Claude subscription reads `0` there and its
 * `tokens*` are the whole of what it spent (operator rule, 2026-09-24).
 */
