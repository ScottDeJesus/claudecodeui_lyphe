...
- **Проводник файлов** - интерактивное дерево файлов с предпросмотром текста, изображений и загрузок только для чтения — изменения вносит агент
...
- **[CodeMirror](https://codemirror.net/)** - редактор Markdown в редакторе PRD
