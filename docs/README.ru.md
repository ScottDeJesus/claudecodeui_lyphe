...
- **Проводник файлов** - интерактивное дерево файлов с редактором текстовых файлов, предпросмотром PDF, Word, таблиц, CSV/TSV, Markdown, изображений, аудио и видео, а для остального — загрузка ([file-manager.md](file-manager.md))
- **Git Explorer** - просмотр ветки, неотправленных коммитов и каждого изменения с его diff — коммиты и push выполняет агент: одна кнопка запускает разговор и выполняет ваш собственный `/git`
...
- **[CodeMirror](https://codemirror.net/)** - редактор кода и Markdown в редакторе PRD и в редакторе файлов вкладки «Файлы»
- **[PDF.js](https://mozilla.github.io/pdf.js/)** - предпросмотр PDF во вкладке «Файлы»
- **[docx-preview](https://github.com/VolodymyrBaydalka/docxjs)** - предпросмотр документов Word во вкладке «Файлы»
- **[SheetJS](https://sheetjs.com/)** - предпросмотр таблиц и CSV/TSV во вкладке «Файлы»
