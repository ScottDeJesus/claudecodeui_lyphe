...
- **文件浏览器** - 交互式文件树，文本文件可用内置编辑器修改，并支持 PDF、Word、表格、CSV/TSV、Markdown、图片、音频和视频的预览，其余文件提供下载 ([file-manager.md](file-manager.md))
...
- **[CodeMirror](https://codemirror.net/)** - PRD 编辑器与文件标签页文件编辑器背后的代码 / Markdown 编辑器
- **[PDF.js](https://mozilla.github.io/pdf.js/)** - 文件标签页的 PDF 预览
- **[docx-preview](https://github.com/VolodymyrBaydalka/docxjs)** - 文件标签页的 Word 文档预览
- **[SheetJS](https://sheetjs.com/)** - 文件标签页的表格与 CSV/TSV 预览
